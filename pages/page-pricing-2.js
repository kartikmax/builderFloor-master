            ...
            <div className="row">
              ...
              <div className="col-lg-10">
                        ...
                        <div className="box-switch">
                          <label>
                            <input
                              ...
                              name="billed_type"
                            />
                            <span className="text-billed text-billed-month active">
                              Monthly
                            </span>
                            <span className="text-billed text-billed-year">
                              Yearly
                            </span>
                          </label>
                        </div>
                    ...
                    <div className="col-xl-6 col-lg-12 col-sm-12">
                      <div className="block-price-item active" data-package={3}>
                        ...
                        <div className="block-pricing-info">
                          ...
                          <span className="tag-round text-body-text">
                            Save %20
                          </span>
                        </div>
                        <div className="box-info-price">
                          ...
                          <span className="text-month for-month text-body-text color-gray-500">
                            /month
                          </span>
                          <span className="text-month for-year text-body-text color-gray-500">
                            /year
                          </span>
                        </div>
                      </div>
                ...
                <div className="text-center mt-30 mb-100">
                  ...
                  <Link href="/#">
                    <a className="btn btn-default icon-arrow-right mb-20">
