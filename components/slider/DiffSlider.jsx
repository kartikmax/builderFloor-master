    ...
    <>
      <>
        ...
        <div className="flex h-[582px] md:h-[350px]">
              ...
              <div className="w-[40px] h-[100%] absolute z-50 left-0 flex items-center justify-center">
                <Image
                  ...
                  onClick={() => {
                    if (curr !== 0) {
                      isImageURL(
                        `https://testerp1apis.nextsolutions.in/${
                          images[curr - 1]
                        }`,
                        curr + 1 - 1
                      );
          ...
          <div className="w-[400px] h-[100%] shrink-0 flex flex-col md:hidden">
            <img
              src={`https://testerp1apis.nextsolutions.in/${images[0]}`}
              alt=""
              onClick={() => {
                isImageURL(
                  `https://testerp1apis.nextsolutions.in/${images[0]}`,
                  1
                );
              }}
              style={{
              ...
              className="w-[400px] h-[194px] cursor-pointer"
            />
            <img
              src={`https://testerp1apis.nextsolutions.in/${images[1]}`}
              alt=""
              onClick={() => {
                isImageURL(
                  `https://testerp1apis.nextsolutions.in/${images[1]}`,
                  2
                );
              }}
              style={{
            ...
            />
            <img
              src={`https://testerp1apis.nextsolutions.in/${images[2]}`}
              alt=""
              onClick={() => {
                isImageURL(
                  `https://testerp1apis.nextsolutions.in/${images[2]}`,
                  3
                );
              }}
              style={{
